...
const faqSchema = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "Làm sao đặt lịch khám tại Viện?", acceptedAnswer: { "@type": "Answer", text: "Đặt online tại website, gọi hotline 0964 392 632, hoặc đến trực tiếp 273-275 Nam Kỳ Khởi Nghĩa, Quận 3." } },
