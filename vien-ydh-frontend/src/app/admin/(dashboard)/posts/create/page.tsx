            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <option value="Sức khỏe & Dinh dưỡng">Sức khỏe & Dinh dưỡng</option>
                  <option value="Hoạt động Viện">Hoạt động Viện</option>
                  <option value="Nghiên cứu khoa học">Nghiên cứu khoa học</option>
                  <option value="Hướng dẫn bệnh nhân">Hướng dẫn bệnh nhân</option>
                </select>
              </div>
